...
# from SoftyXbot.modules.sql import warns_sql as warnssql
import SoftyXbot.modules.sql.blacklist_sql as blacklistsql

# from SoftyXbot.modules.sql import cust_filters_sql as filtersql
# import SoftyXbot.modules.sql.welcome_sql as welcsql
import SoftyXbot.modules.sql.locks_sql as locksql
import SoftyXbot.modules.sql.notes_sql as sql

# from SoftyXbot.modules.rules import get_rules
import SoftyXbot.modules.sql.rules_sql as rulessql
from SoftyXbot import EVENT_LOGS,OWNER_ID, SUPPORT_CHAT, dispatcher
from SoftyXbot.__main__ import DATA_IMPORT
from SoftyXbot.modules.connection import connected
from SoftyXbot.modules.helper_funcs.alternate import typing_action
from SoftyXbot.modules.helper_funcs.chat_status import user_admin
from SoftyXbot.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("SoftyXbot{}backup.json".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("SoftyXbot{}backup.json".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `SoftyXbot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("SoftyXbot{}backup.json".format(chat_id))  # Cleaning file
