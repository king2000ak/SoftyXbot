...
import SoftyXbot.modules.sql.global_bans_sql as gban_sql
import SoftyXbot.modules.sql.users_sql as user_sql
from SoftyXbot import DEV_USERS, OWNER_ID, dispatcher
