...
import SoftyXbot.modules.sql.connection_sql as sql
from SoftyXbot import DEV_USERS, DRAGONS, dispatcher
from SoftyXbot.modules.helper_funcs import chat_status
